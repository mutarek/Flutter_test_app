...
public class LordsMobileFragment extends Fragment {
    ...
    private List<Lords_Model> pubg_models;
    private Lords_Adapters pubg_adapter;
    ...
    private void casting(View view) {
        buyNow = view.findViewById(R.id.lords_buyNow);
        radioGroup = view.findViewById(R.id.lords_radio_group);
        rb1 = view.findViewById(R.id.lords_rb1);
        rb2 = view.findViewById(R.id.lords_rb2);
        rb3 = view.findViewById(R.id.lords_rb3);
        rb4 = view.findViewById(R.id.lords_rb4);
        rb5 = view.findViewById(R.id.lords_rb5);
        rb6 = view.findViewById(R.id.lords_rb6);
        playerID = view.findViewById(R.id.lords_player_id);
        paymentRadioGroup = view.findViewById(R.id.lords_payment_rg);
        p1 = view.findViewById(R.id.lords_bkash_rb);
        p2 = view.findViewById(R.id.lords_rocket_rb);
        p3 = view.findViewById(R.id.lords_nagad_rb);
        p4 = view.findViewById(R.id.lords_nwallet_rb);
        recyclerView = view.findViewById(R.id.lords_recyller);
        contentLoadingProgressBar = view.findViewById(R.id.lords_progress);
    ...
    private void initPriceRange() {
        priceRef = db.collection("Price_Range").document("Lords");
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                Lords_Model fireModel = document.toObject(Lords_Model.class);
                                pubg_models.add(fireModel);
                                pubg_adapter = new Lords_Adapters(pubg_models, mContext);
