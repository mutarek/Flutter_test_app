...
import com.techtrickbd.nahidshop.adapters.Saint_Adapters;
...
public class SaintSeiyaFragment extends Fragment {
    ...
    private List<Saint_Model> pubg_models;
    private Saint_Adapters pubg_adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_saint_seiya, container, false);
        casting(view);
    ...
    private void casting(View view) {
        buyNow = view.findViewById(R.id.saint_buyNow);
        radioGroup = view.findViewById(R.id.saint_radio_group);
        rb1 = view.findViewById(R.id.saint_rb1);
        rb2 = view.findViewById(R.id.saint_rb2);
        rb3 = view.findViewById(R.id.saint_rb3);
        rb4 = view.findViewById(R.id.saint_rb4);
        rb5 = view.findViewById(R.id.saint_rb5);
        rb6 = view.findViewById(R.id.saint_rb6);
        rb7 = view.findViewById(R.id.saint_rb7);
        rb8 = view.findViewById(R.id.saint_rb8);
        playerID = view.findViewById(R.id.saint_player_id);
        serverID = view.findViewById(R.id.saint_server_id);
        paymentRadioGroup = view.findViewById(R.id.saint_payment_rg);
        p1 = view.findViewById(R.id.saint_bkash_rb);
        p2 = view.findViewById(R.id.saint_rocket_rb);
        p3 = view.findViewById(R.id.saint_nagad_rb);
        p4 = view.findViewById(R.id.saint_nwallet_rb);
        recyclerView = view.findViewById(R.id.saint_recyller);
        contentLoadingProgressBar = view.findViewById(R.id.saint_progress);
    ...
    private void initRecyller() {
        free_fire = db.collection("Saint_Seiya");
        free_fire
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                Saint_Model fireModel = document.toObject(Saint_Model.class);
                                pubg_models.add(fireModel);
                                pubg_adapter = new Saint_Adapters(pubg_models, mContext);
    ...
    private void googingtoPurchase() {
        ...
        intent.putExtra("from", "Saint_Seiya");
